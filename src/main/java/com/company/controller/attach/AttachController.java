...
public class AttachController {
    ...
    @GetMapping(value = "/admUser/open/{fileName}", produces = MediaType.IMAGE_PNG_VALUE)
    ...
    @GetMapping(value = "/admUser/open_general/{fileName}", produces = MediaType.ALL_VALUE)
    public byte[] open_general(@PathVariable("fileName") String fileName) {
        log.info("Request for open general {}" , fileName);
        return attachService.open_general(fileName);
    }


    @GetMapping("/admUser/download/{fineName}")
